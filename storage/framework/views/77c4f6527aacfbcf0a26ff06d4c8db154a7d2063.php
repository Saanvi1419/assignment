...
<?php else: ?>
<button class="btn" href="<?php echo e(route('login')); ?>"><b>LOGIN</b></button><br>
<?php if(route::has('register')): ?>
<p style="font-size:1vw" class="register"><b>If Not a User</br>
<a href="<?php echo e(route('register')); ?>">Register</a> here.
</b></p>
<?php endif; ?>
<?php endif; ?>
<?php endif; ?>
...
</html><?php /**PATH C:\xampp\htdocs\dup\resources\views/welcome.blade.php ENDPATH**/ ?>